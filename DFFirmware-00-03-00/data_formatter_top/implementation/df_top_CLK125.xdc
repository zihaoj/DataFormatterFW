...
create_clock -period 8.000 -name refclk4_i -waveform {0.000 4.000} [get_ports {GTREFCLK_P_IN[4]}]
create_clock -period 8.000 -name refclk5_i -waveform {0.000 4.000} [get_ports {GTREFCLK_P_IN[5]}]
create_clock -period 5.000 -name eth_gtrefclk -waveform {0.000 2.500} [get_ports ETH_GTREFCLK_P_IN]
...
create_clock -period 5.000 -name fmc_common_clk_i -waveform {0.000 2.500} [get_pins CLKBUFFER/inst/mmcm_adv_inst/CLKOUT0]
create_clock -period 8.000 -name main_clk_i -waveform {0.000 4.000} [get_pins CLKBUFFER/inst/mmcm_adv_inst/CLKOUT1]
create_clock -period 20.000 -name clk50_i -waveform {0.000 10.000} [get_pins CLKBUFFER/inst/mmcm_adv_inst/CLKOUT2]

#create_clock -name fmc_common_clk_i [get_pins CLKBUFFER/U0/mmcm_adv_inst/CLKOUT0]
#create_clock -name main_clk_i  [get_pins CLKBUFFER/U0/mmcm_adv_inst/CLKOUT1]
#create_clock -name clk50_i [get_pins CLKBUFFER/U0/mmcm_adv_inst/CLKOUT2]
...
#create_generated_clock -name eth_txoutclk [get_pins MY_USER_INTERFACE/eth/phy/U0/transceiver_inst/gtwizard_inst/U0/gtwizard_i/gt0_GTWIZARD_i/gthe2_i/TXOUTCLK]
#create_generated_clock -name eth_rxoutclk [get_pins MY_USER_INTERFACE/eth/phy/U0/transceiver_inst/gtwizard_inst/U0/gtwizard_i/gt0_GTWIZARD_i/gthe2_i/RXOUTCLK]
...
set_false_path -from [get_clocks clk50_i] -to [get_clocks refclk4_i]
set_false_path -from [get_clocks refclk4_i] -to [get_clocks clk50_i]

set_false_path -from [get_clocks clk50_i] -to [get_clocks refclk5_i]
set_false_path -from [get_clocks refclk5_i] -to [get_clocks clk50_i]
...
set_false_path -from [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/rst_i_reg[0]/C}] -to [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/STEP_GENERATE[0].SWITCH_GENERATE[10].SWITCH_ELEMENT/INPUT_POT2/dest_outport2_i_reg[23]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/rst_i_reg[0]/C}] -to [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/STEP_GENERATE[0].SWITCH_GENERATE[10].SWITCH_ELEMENT/INPUT_POT2/dest_outport2_i_reg[24]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/rst_i_reg[0]/C}] -to [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/STEP_GENERATE[0].SWITCH_GENERATE[10].SWITCH_ELEMENT/INPUT_POT2/dest_outport2_i_reg[25]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/rst_i_reg[0]/C}] -to [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/STEP_GENERATE[0].SWITCH_GENERATE[10].SWITCH_ELEMENT/INPUT_POT2/dest_outport2_i_reg[27]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/rst_i_reg[0]/C}] -to [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/STEP_GENERATE[0].SWITCH_GENERATE[15].SWITCH_ELEMENT/INPUT_POT1/output_buf_i_reg[2][0]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/rst_i_reg[0]/C}] -to [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/STEP_GENERATE[0].SWITCH_GENERATE[15].SWITCH_ELEMENT/INPUT_POT1/output_buf_i_reg[2][1]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_INTERNAL_LINK_OUTPUT.my_internal_link_output/CENTRAL_SWTICH_INST.CENTRAL_SWITCH/rst_i_reg[0]/C}] -to [get_pins {MY_DF_MAIN/INST_INTERNAL_LINK_OUTPUT.my_internal_link_output/CENTRAL_SWTICH_INST.CENTRAL_SWITCH/STEP_GENERATE[0].SWITCH_GENERATE[11].SWITCH_ELEMENT/OUTPUT_PORT1/PORT2_SHORT_FIFO_INST.INPUT_PORT2/empty_buf_reg/PRE}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_INTERNAL_LINK_OUTPUT.my_internal_link_output/CENTRAL_SWTICH_INST.CENTRAL_SWITCH/rst_i_reg[0]/C}] -to [get_pins {MY_DF_MAIN/INST_INTERNAL_LINK_OUTPUT.my_internal_link_output/CENTRAL_SWTICH_INST.CENTRAL_SWITCH/STEP_GENERATE[0].SWITCH_GENERATE[11].SWITCH_ELEMENT/OUTPUT_PORT1/output_buf_i_reg[3]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_INTERNAL_LINK_OUTPUT.my_internal_link_output/CENTRAL_SWTICH_INST.CENTRAL_SWITCH/rst_i_reg[0]/C}] -to [get_pins {MY_DF_MAIN/INST_INTERNAL_LINK_OUTPUT.my_internal_link_output/CENTRAL_SWTICH_INST.CENTRAL_SWITCH/STEP_GENERATE[0].SWITCH_GENERATE[11].SWITCH_ELEMENT/OUTPUT_PORT1/output_buf_i_reg[4]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_INTERNAL_LINK_OUTPUT.my_internal_link_output/CENTRAL_SWTICH_INST.CENTRAL_SWITCH/rst_i_reg[0]/C}] -to [get_pins {MY_DF_MAIN/INST_INTERNAL_LINK_OUTPUT.my_internal_link_output/CENTRAL_SWTICH_INST.CENTRAL_SWITCH/STEP_GENERATE[0].SWITCH_GENERATE[11].SWITCH_ELEMENT/OUTPUT_PORT1/output_buf_i_reg[9]/CLR}]

set_false_path -from [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/rst_i_reg[1]/C}] -to [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/STEP_GENERATE[1].SWITCH_GENERATE[5].SWITCH_ELEMENT/INPUT_POT1/output_buf_i_reg[1][19]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/rst_i_reg[1]/C}] -to [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/STEP_GENERATE[1].SWITCH_GENERATE[5].SWITCH_ELEMENT/INPUT_POT1/output_buf_i_reg[1][26]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/rst_i_reg[1]/C}] -to [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/STEP_GENERATE[1].SWITCH_GENERATE[5].SWITCH_ELEMENT/INPUT_POT1/output_buf_i_reg[1][27]/CLR}]
set_false_path -from [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/rst_i_reg[1]/C}] -to [get_pins {MY_DF_MAIN/INST_OUTPUT_DATA_OPERATOR.my_output_data_operator/SWTICH_INST.OUTPUT_SWITCH/STEP_GENERATE[1].SWITCH_GENERATE[5].SWITCH_ELEMENT/INPUT_POT1/output_buf_i_reg[2][6]/CLR}]
